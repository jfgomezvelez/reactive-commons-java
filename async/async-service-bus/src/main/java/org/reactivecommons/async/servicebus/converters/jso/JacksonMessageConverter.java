package org.reactivecommons.async.servicebus.converters.jso;
...
public class JacksonMessageConverter implements MessageConverter {
    ...
    public Message toMessage(Object object) {
        ...
        ServiceBusMessage.ServiceBusMessageProperties props = new ServiceBusMessage.ServiceBusMessageProperties();
        props.setContentType(CONTENT_TYPE);
        props.setContentEncoding(ENCODING);
        props.setContentLength(bytes.length);
        return new ServiceBusMessage(bytes, props);
    }
